          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <strong> B.E Computer Science and Engineering </strong> - Sri Venkateswara College of Engineering
                  (2022-2026)
                </li>
                <li>
                  Relevant Coursework: Data Structures and Algorithms, Cloud Computing, DBMS, Computer Networks
                </li>
              </ul>
            </div>
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                <div>
                  <h4 className="font-semibold">
                    {" "}Web Developer Intern at Cognifyz Technologies (Aug 2023 - Sep 2023){" "}
                  </h4>
                  <br></br>
                  <p>
                    Developed and maintained web applications using React and Node.js. Collaborated with cross-functional teams to design and implement new features.
                  </p>
                </div>
              </div>
            </div>
